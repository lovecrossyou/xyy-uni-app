<template>
	<view class="wrapper">
		...
		<view>
			<view @click="amendName(amendName)"><modifiedData title="用户名" desc="chechero"></modifiedData></view>
			<view @click="popMenu"><modifiedData title="性别" desc="女"></modifiedData></view>
			<view @click="popMenu"><modifiedData title="手机"></modifiedData></view>
		</view>
			...
			uni.chooseImage({
				success: chooseImageRes => {
					...
					uni.uploadFile({
						...
						// 							that.image_path=res.data.image_path;
						// 						}
						success: uploadFileRes => {
							console.log("uploadFileRes.data",uploadFileRes.data);
							that.image_path = uploadFileRes.data.image_path;
						}
					});
				}
			});
