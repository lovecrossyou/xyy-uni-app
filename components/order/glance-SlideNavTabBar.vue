...
<template name="glance-SlideNavTabBar">
	<!-- 预留间隙 顶吸控制-->
	<view
		style="padding: 10px 0 5px 0; position: -webkit-sticky;box-sizing: border-box;"
					...
					<view v-for="(items, index) in gettabbars" :key="index">
						...
						>
							...
							<view
								...
								:style="{
									color: [index == activeitemindex ? activetextcolor : textcolor]
								}"
							>
								{{ items.textcontent }}
							</view>
							<!-- 下划线父标签控制 -->
							<view
								style="display: flex;justify-content: center;height: 10upx;min-height: 10upx; width: 100%;"
							>
								<!-- 下划线标签样式控制 -->
								<view
